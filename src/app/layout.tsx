...
import './globals.css';
import Header from '@/components/Layout/Header'; // Sử dụng alias @/src
import Footer from '@/components/Layout/Footer'; // Sử dụng alias @/src
...
export const metadata: Metadata = {
    title: 'VERONA PIZZA - Fast Food Delivery',
