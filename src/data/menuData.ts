...
// Đảm bảo các file ảnh này tồn tại trong thư mục src/assets/images/categories/
...
// Đảm bảo các file ảnh này tồn tại trong thư mục src/assets/images/menu/hotCombo/
...
// Đảm bảo các file ảnh này tồn tại trong thư mục src/assets/images/menu/burger/
...
export const menuCategories: Category[] = [
    { id: 'hot-combo', name: 'Hot Combo', icon: hotComboIcon.src }, // .src để lấy đường dẫn thực tế từ import
...
export const menuItems: MenuItem[] = [
    {
        ...
        price: 550000,
        image: combo1Img.src, // .src để lấy đường dẫn thực tế từ import
